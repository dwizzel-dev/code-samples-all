...
dynamic class irc.CieAdmin{
	...
	private function Init(Void):Void{
		...
		strXml += '<P n="_tl" content="mvContent" bgcolor="' + CieStyle.__panel.__bgColor + '" scroll="false" effect="false"></P>';
		strXml += '</PT>';
		...
		new CieCornerSquare(this.__arrPanel['private'], this.__hvSpacer, this.__hvSpacer, (this.__listWidth * 2), (this.__panelLastSize.__height - (this.__hvSpacer * 2)), [CieStyle.__basic.__toolRadius, CieStyle.__basic.__toolRadius, CieStyle.__basic.__toolRadius, CieStyle.__basic.__toolRadius], [0xffffff, 100], ['ext', 0.5, 0x999999, 100]);
		...
		this.__arrPane['private'].setSize((this.__listWidth * 2), (this.__panelLastSize.__height - (this.__hvSpacer * 2)));
		this.__arrPane['private'].move(this.__hvSpacer, this.__hvSpacer);
		this.__arrPane['private'].contentPath = 'mvContent';
		//set a butt to clear
		var bTPrivateClear = new CieButton(this.__arrPanel['private'], gLang[15], this.__buttWidth, this.__buttHeight, ((this.__listWidth * 2)+ (this.__hvSpacer * 2)), this.__hvSpacer);	

...
dynamic class irc.CieIrc{
	...
	public function reset(bReconnect:Boolean):Void{
		...
		cFunc.reset();
		//reload content tree
		cContent.createFromXmlFile('irc.content.xml');
	...
	private function initLang(Void):Void{
		...
		Debug('loading mvLangLoader with irc.' + BC.__user.__lang + '.swf');
		__stageWinLayer.mvLangLoader.loadMovie('irc.' + BC.__user.__lang + '.swf');
		setLoadingBar(70);
		};	

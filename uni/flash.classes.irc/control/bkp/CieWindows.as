...
dynamic class control.CieWindows{
	...
	private var __randNum:Number;
	
	
	public function CieWindows(strTitle:String, cbFunc:Function, cbClass:Object){
		var iMax = 100000;
		var iMin = 1;
		this.__randNum = Math.round(Math.random() * (iMax-iMin)) + iMin;
		...
		//emplty layer
		this.__mvEmpty = __stageWinLayer.createEmptyMovieClip('mvEmpty' + this.__randNum, __stageWinLayer.getNextHighestDepth());
		//bg layer for suaer dark
		this.__mvLayer = this.__mvEmpty.createEmptyMovieClip('mvLayer' + this.__randNum, this.__mvEmpty.getNextHighestDepth());
		...
		//the window
		this.__mvWindow = this.__mvEmpty.createEmptyMovieClip('mvWindow' + this.__randNum,this.__mvEmpty.getNextHighestDepth());
		//the window content
		this.__mvContent = this.__mvWindow.createEmptyMovieClip('mvContent' + this.__randNum,this.__mvWindow.getNextHighestDepth());
		//the eindow title bar
		this.__mvTitleBar = this.__mvWindow.createEmptyMovieClip('mvTitleBar' + this.__randNum, this.__mvWindow.getNextHighestDepth());
		//the close butt of the title bar
		this.__mvCloseButt = this.__mvTitleBar.createEmptyMovieClip('mvCloseButt' + this.__randNum, this.__mvTitleBar.getNextHighestDepth());
		//the title of the window
		this.__mvTitle = this.__mvTitleBar.createEmptyMovieClip('mvTitle' + this.__randNum, this.__mvTitleBar.getNextHighestDepth());
	...
	public function setWindow(Void):Void{
		...
		this.__mvCloseButt.attachMovie('mvTabCloseButt','mvCloseButt' + this.__randNum, this.__mvCloseButt.getNextHighestDepth());
	...
	public function resize(w:Number, h:Number):Void{
		/*
		Debug("WINDOW_WITDH: " + this.__mvWindow._width);
		Debug("WINDOW_HEIGHT: " + this.__mvWindow._height);
		*/
	...
	public function destroy(Void):Void{
		//Debug("Window.Destoy():" + this.__mvWindow);

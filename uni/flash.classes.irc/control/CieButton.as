...
dynamic class control.CieButton{
	...
	//new text
	public function setNewText(str:String):Void{
		this.__cTextLine.setNewText(str);
		this.redraw(this.__x, this.__y);
		};	
	...
	public function changeTextColorEffect(bOn:Boolean):Void{ //call by cieTool when set by setButton
		if(bOn){
			this.changeTextColor(CieStyle.__basic.__buttonFontColorOver);
		}else{
			this.changeTextColor(CieStyle.__basic.__buttonFontColor);
			}
		};	
	...
	public function getIconPos(Void):Object{

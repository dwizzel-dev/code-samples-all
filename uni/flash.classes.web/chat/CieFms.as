...
dynamic class chat.CieFms{
	...
	public function openChat(ctype:String):Void{
		...
		this.__panelClass.setBgColor(CieStyle.__profil.__bgTopColor);
		var mvPanelProfil:MovieClip = this.__panelClass.getPanelContent();
		mvPanelProfil.txtPseudo.htmlText = '<font color="' + CieStyle.__profil.__fontColor + '">' + gLang[0] + BC.__user.__pseudo + gLang[1] + BC.__user.__age + gLang[2] + '</font>'; 
		mvPanelProfil.txtSexe.htmlText = '<font color="' + CieStyle.__profil.__fontColor + '">' + unescape(BC.__user.__sexe) + ", " + unescape(BC.__user.__etatcivil) + ", " + unescape(BC.__user.__orientation) +  '</font>'; 
		mvPanelProfil.txtVille.htmlText = '<font color="' + CieStyle.__profil.__fontColor + '">' + unescape(BC.__user.__location) + '</font>'; 	
		mvPanelProfil.txtSlogan.htmlText = '<font color="' + CieStyle.__profil.__fontColor + '">' + "\"" + unescape(BC.__user.__titre) + "\"" + '</font>';
		
		//Debug('PANEL: ' + mvPanelProfil);
	...
	public function resizeTopPanelContent(w:Number, h:Number):Void{
		...
		this.__mvChatAll.txtInfos._width = w - CieStyle.__profil.__scrollWidth  - this.__hvSpacer; 
		//the scroll
	...
	public function showBottomNavigation(ctype:String):Void{
		...
		this.__mvChatAll.txtInfos._width = objSize.__width - CieStyle.__profil.__scrollWidth - this.__hvSpacer;;

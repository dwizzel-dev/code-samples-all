...
dynamic class alert.CieConfigManager{	
	...
	private function CieConfigManager(callBackFunction:Function, callBackClass:Object){
		...
		this.__configFileName = 'alert.config.xml';
	...
	public function getLang(Void):Void{
		new CieXmlParser('alert.lang.' + BC.__user.__lang + '.xml' , CieLang, this.cbLang, this);
		};
		
	public function cbLang(cbClass:Object):Void{
		Debug('alert.lang.' + BC.__user.__lang + '.xml' + ' loaded succesfully');
		//loading sequence
		cbClass.getError();
		};	
	*/	
	...
	public function getError(Void):Void{
		new CieXmlParser('alert.error.' + BC.__user.__lang + '.xml' , CieError, this.cbError, this);
		};
		
	public function cbError(cbClass:Object):Void{
		Debug('alert.error.' + BC.__user.__lang + '.xml' + ' loaded succesfully');
		cbClass.__cbFunction(cbClass.__cbClass);
		};	
	*/

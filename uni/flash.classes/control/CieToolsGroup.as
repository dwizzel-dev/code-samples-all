...
dynamic class control.CieToolsGroup{
	...
	public function CieToolsGroup(mv:MovieClip, offSetY:Number){
		this.__mv = mv;
	...
	public function	setBubble(toolName:String, strBubbleText:String):Void{
		if(this.__tools[toolName] != undefined){
			this.__tools[toolName].setBubble(strBubbleText);
			}
		};	

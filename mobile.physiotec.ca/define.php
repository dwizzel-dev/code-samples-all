...
// ABSOLUTE PATH
define('DIR', '/var/www/mobile....@physiotec.ca/');
...
// RELATIVE PATH
define('PATH_WEB', 'https://'.PATH_USER.'mobile....@physiotec.ca/');
define('PATH_EXERCICE_IMAGE', 'https://'.PATH_USER.'hep....@physiotec.ca/img/exercise.php?param=');
define('PATH_PRINT', 'https://'.PATH_USER.'hep....@physiotec.ca/pdf_templates/');
//define('PATH_PRINT', 'https://'.PATH_USER.'hep....@physiotec.ca/pdf/program.pdf');
define('PATH_PDF_VIEWER', 'https://'.PATH_USER.'hep....@physiotec.ca/js/pdfjs.stable/web/viewer.php?file=');
define('PATH_PROGRAM_CLIENT_EMAIL', 'https://'.PATH_USER.'hep....@physiotec.ca/');
...
//LIMITS AND NUMS
define('MAX_ROWS_AUTOCOMPLETE_RETURNED', 10); //retour du autocomplete max
define('MAX_LOG_ERROR', 5); 
define('MAX_SEARCH_NUM_ROWS', 1500); //le max de retour des recherches exercies

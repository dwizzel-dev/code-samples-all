...
class Test {
	...
	//-------------------------------------------------------------------------------------------------------------	
	public function testGetClinicOptionTitle($data){
		
		return $this->reg->get('utils')->getClinicOptionTitle();	

		}

	//-------------------------------------------------------------------------------------------------------------	
	public function testGetLicenceOptionTitle($data){
		
		return $this->reg->get('utils')->getLicenceOptionTitle();	

		}

	//-------------------------------------------------------------------------------------------------------------	
	public function testGetBrandOptionTitle($data){
		
		return $this->reg->get('utils')->getBrandOptionTitle();	

...
function JAppz(){
	...
	this.buildPrintPdfLink = function(){
		...
		if(arrField.length > 0){
			...
			old format: https://dev....@physiotec.ca/pdf_templates/2_per_page_text_long.pdf?
				&PHPSESSID=bmt7777d4v4h1npfkko4ci6g2cqsnqld
				&idProgram=2194584
				&picture_type=picture
				&program_locale=fr_CA
				&mobile=1" 
			
			new format: https://dev....@physiotec.ca/pdf/program.pdf?
				idProgram=207763
				&picture_type=picture
				&program_locale=en_US
				&params=1~l~0~26~1~0~0~0
				&api=1
			*/
			//
			var strLink = gPrintServer + '?';
				...
				strLink += '&params=' + this.printTemplate[strSize];
				strLink += '&api=1';
				//strLink += '&mobile=1';	

			this.debug('PRINT LINK: ' + strLink);

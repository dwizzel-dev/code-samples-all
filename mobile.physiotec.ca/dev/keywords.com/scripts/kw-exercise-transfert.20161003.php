...
//LE SELECT DE BASE
$gBaseQuery = 'SELECT idExercise AS "id", data AS "data", rank AS "rank", idUser AS "idUser" FROM exercise WHERE ready = "1" AND oldIdExercise <> 0 ORDER BY idExercise ASC LIMIT ';
//LOOP DES CHUNKS
while($gContinue){
	//select from DB

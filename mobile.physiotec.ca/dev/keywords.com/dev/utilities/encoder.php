...
$bBuildPath = false;
$baseWebPath = 'https://mobile....@physiotec.ca/dev/keywords.com/service.php?';
$buildWebPath = '';
$arrInput = array(
	array(
		'type' => 'text',
...
foreach($arrInput as $k=>$v){
	if($v['type'] == 'text'){ //text input
		...
		if($v['value'] != ''){	
			...
			$strOutput .= '{"username":"","password":""}';
			}
		$strOutput .= '</textarea><br>';

...
define('DIR_TEMPLATE', DIR.'template/'.TEMPLATE_NAME.'/');
...
define('PATH_CSS', PATH_WEB.'css/'.TEMPLATE_NAME.'/');
define('PATH_JS', PATH_WEB.'js/'.TEMPLATE_NAME.'/');
define('PATH_CACHE_JS', PATH_WEB.'temp/cache/js/');
define('PATH_IMAGE', PATH_WEB.'images/'.TEMPLATE_NAME.'/');

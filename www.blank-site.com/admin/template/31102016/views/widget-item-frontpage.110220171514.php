...
@auth:	Dwizzel
@date:	00-00-0000
@info:	default widget-item frontpage view
...
function insertItems(){
	...
	code += '<input type="text" value="1.0" class="form-control" placeholder="" id="modify-input-css_class-' + gCmptItemBlock + '">';
	code += '</div>';	
	//background colors
...
function addEditor(strId){
	var obj = {
		...
		content_css : [
			...
			'<?php echo PATH_CSS; ?>editor/widget-frontpage-item.css'
			],
		inline: false,
		height : 250,
		...
		//preview plugin
		plugin_preview_type: 'widget-frontpage-item', //le type de widget pour le preview
